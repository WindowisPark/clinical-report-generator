-- Generated from: get_diagnosis_by_treatment_act.yaml
-- Parameters used: {'act_kw': 'test_string', 'snapshot_dt': '2025-09-01'}
...
WITH acts AS (  -- 키워드가 포함된 행위가 수행된 (user_id, 진료일) 집합
    ...
    WHERE UPPER(dt.res_code_name) LIKE CONCAT('%', UPPER('test_string'), '%')
