-- Generated from: extract_patients_by_age_gender.yaml
-- Parameters used: {'min_age': 35, 'max_age': 35, 'min_visits': 3, 'snapshot_dt': '2025-09-01'}

-- 특정 연령대와 성별 조건에 맞는 환자 기본 정보 추출
-- 파라미터: min_age = 35, max_age = 35, min_visits = 3
...
WHERE ip.birthday IS NOT NULL
  ...
  AND YEAR(CURRENT_DATE()) - TRY_CAST(LEFT(ip.birthday, 4) AS INT) BETWEEN 35 AND 35
