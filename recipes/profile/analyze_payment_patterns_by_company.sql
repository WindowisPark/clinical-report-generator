-- 보험사별 결제 패턴 및 의료비 분석
-- 파라미터: analysis_period_start = {{ analysis_period_start }}, analysis_period_end = {{ analysis_period_end }}
...
company_stats AS (
  ...
  WHERE payment_date >= '{{ analysis_period_start }}'
    AND payment_date <= '{{ analysis_period_end }}'
